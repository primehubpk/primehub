...
const FALLBACK_CONTENT = 'By using PrimeHub Deals, you agree to use the website for lawful shopping and communication. Product availability, pricing, delivery and other details may change as the store is updated.';

export default function Page() {
  const { settings, loading } = useSettings();
  const policy = settings.policies?.terms;
