...
- Generic requests such as “bangles” still return the collection overview; a specific style/name such as a specific style/name or named deal returns verified product cards.
