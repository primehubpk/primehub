...
export default function HeroFlashBanner() {
  ...
  const discount = bigDeal && Number(bigDeal.originalPrice) > Number(bigDeal.dealPrice)
    ? Math.round(((Number(bigDeal.originalPrice) - Number(bigDeal.dealPrice)) / Number(bigDeal.originalPrice)) * 100)
    : 0;
