...
import type { Category, Product as SharedProduct, SiteSettings } from '@/lib/types';
...
export default function HomePageClient({ initialProducts, initialCategories, initialSettings }: Props) {
