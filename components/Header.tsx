...
import { ReceiptText, Search, ShoppingCart, ShieldCheck } from 'lucide-react';
    ...
    <header className="border-b border-black/10 bg-[#F8F7F3] shadow-[0_8px_30px_rgba(20,20,15,0.04)]">
      <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 lg:gap-7">
          ...
          <nav className="hidden items-center gap-3 lg:flex"><button type="button" onClick={() => router.push('/orders')} className="group flex flex-col items-center gap-1 text-[10px] font-bold" aria-label="My Orders"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#171711] via-[#2B281C] to-[#9B6800] text-[#FFD979] shadow-[0_7px_18px_rgba(155,104,0,0.24)] ring-1 ring-[#E7B84B]/35 transition group-hover:-translate-y-0.5"><ReceiptText size={18}/></span><span>My Orders</span></button><button type="button" onClick={openDrawer} className="group relative flex flex-col items-center gap-1 text-[10px] font-bold" aria-label={`Cart, ${cartCount} items`}><span className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-[#171711] via-[#2B281C] to-[#9B6800] text-[#FFD979] shadow-[0_7px_18px_rgba(155,104,0,0.24)] ring-1 ring-[#E7B84B]/35 transition group-hover:-translate-y-0.5"><ShoppingCart size={18}/>{cartCount > 0 && <span className="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-[#E1352B] text-[9px] text-white ring-2 ring-[#F8F7F3]">{cartCount}</span>}</span><span>Cart</span></button></nav>
          <div className="ml-auto flex items-start gap-2 lg:hidden"><button type="button" onClick={() => router.push('/orders')} className="group flex flex-col items-center gap-1" aria-label="My Orders"><span className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#171711] via-[#2B281C] to-[#9B6800] text-[#FFD979] shadow-[0_8px_22px_rgba(155,104,0,0.28)] ring-1 ring-[#E7B84B]/40"><ReceiptText size={17}/></span><span className="text-[7px] font-black text-black/55">MY ORDERS</span></button><button type="button" onClick={openDrawer} className="group relative flex flex-col items-center gap-1" aria-label={`Cart, ${cartCount} items`}><span className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#171711] via-[#2B281C] to-[#9B6800] text-[#FFD979] shadow-[0_8px_22px_rgba(155,104,0,0.28)] ring-1 ring-[#E7B84B]/40"><ShoppingCart size={18}/>{cartCount > 0 && <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#E1352B] text-[9px] font-bold text-white ring-2 ring-[#F8F7F3]">{cartCount}</span>}</span><span className="text-[7px] font-black text-black/55">CART</span></button></div>
        </div>
