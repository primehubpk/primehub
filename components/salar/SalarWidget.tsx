...
type ChatMessage = { id: string; role: 'user'|'assistant'|'system'; text: string; attachments?: { products?: ProductAttachment[] } | any[]; created_at?: string };

function productsOf(message: ChatMessage): ProductAttachment[] {
  const value: any = message.attachments;
  return value && !Array.isArray(value) && Array.isArray(value.products) ? value.products : [];
}
