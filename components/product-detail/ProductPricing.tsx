...
export default function ProductPricing({ product, rating, reviews, currentDeal, activeDeal = false, liveDeal, dealPrice, regularPrice, productOriginal, normalForDeal, savingsAmount, afterPricing }: Props) {
