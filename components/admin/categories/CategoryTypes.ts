...
export type BucketFormProps = { bucketForm: PriceBucket; editingBucketId: string | null; isSaving: boolean; uploading: boolean; fileInputRef: RefObject<HTMLInputElement | null>; onChange: (updater: (current: PriceBucket) => PriceBucket) => void; onOpenGallery: () => void; onUploadDevice: () => void; onSubmit: (event: FormEvent<HTMLFormElement>) => Promise<void>; onCancel: () => void };
...
export type CategoryGalleryProps = { showGallery: boolean; gallerySearch: string; galleryTarget: GalleryTarget; gallery: MediaAsset[]; selectedUrl: string; uploading: boolean; fileInputRef: RefObject<HTMLInputElement | null>; onClose: () => void; onSearchChange: (value: string) => void; onChoose: (url: string) => void; onUpload: () => void };
