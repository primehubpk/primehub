...
export default function CategoriesManager() {
  ...
  return <section className="mx-auto max-w-5xl px-4 py-6">
    ...
    {manager.tab === 'categories' && <>
      ...
      <button type="button" disabled={manager.isSaving} onClick={manager.repairCategorySlugs} className="mt-4 rounded-xl bg-[#E1352B] px-4 py-2.5 text-xs font-black text-white disabled:opacity-50">Repair all category links</button>
