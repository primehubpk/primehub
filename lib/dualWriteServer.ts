...
export function getDualWriteMode(): DualWriteMode {
  return process.env.PRIMEHUB_BACKEND_WRITE_MODE === 'supabase-primary' ? 'supabase-primary' : 'firebase-primary';
}
...
function common(data: Record<string, any>) {
  return {
