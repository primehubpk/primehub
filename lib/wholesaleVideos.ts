...
export type WholesaleVideo={id:string;title:string;platform:VideoPlatform;url:string;thumbnailUrl?:string;description?:string;price?:number;active?:boolean};
