...
export interface DailyDeal { productId:string; imageUrl:string; imageUrls?:string[]; originalPrices?:number[]; dealPrices?:number[]; title:string; originalPrice:number; dealPrice:number; startAt:string; endAt:string; buttonText:string; buttonLink:string; active:boolean; }
