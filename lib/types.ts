...
export interface DailyDeal { productId:string; productIds?:string[]; imageUrl:string; imageUrls?:string[]; titles?:string[]; categoryIds?:string[]; originalPrices?:number[]; dealPrices?:number[]; rotationStartedAt?:string; title:string; originalPrice:number; dealPrice:number; startAt:string; endAt:string; buttonText:string; buttonLink:string; active:boolean; }
