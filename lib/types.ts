...
export interface PriceBucket { id:string; title:string; amount:number; iconUrl:string; accent:string; sortOrder:number; active:boolean; }
...
export interface Product { id:string; title:string; price:number; originalPrice:number; category:string; stock:number; isWeekendSpecial:boolean; isFlashSale:boolean; imageUrl:string; videoUrl?:string; }
